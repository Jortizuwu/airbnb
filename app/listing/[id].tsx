...
const DetailsPage = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={defualtStyle.footer} entering={SlideInDown.delay(200)}>
        <View
          ...
          <TouchableOpacity style={[defualtStyle.btn, { paddingRight: 20, paddingLeft: 20 }]}>
            <Text style={defualtStyle.btnText}>Reserve</Text>
          </TouchableOpacity>
        </View>
      </Animated.View>
    </View>
